...
describe('processFileInfo', () => {
 ...
 test('should return complete info with priority true', () => {
 ...
 test('should return complete info with priority false', () => {
 ...
 test('should handle complex paths', () => {
   ...
   const result = processFileInfo('/home/user/geo_2024.gpkg', true);
   expect(result).toEqual({
     path: '/home/user/geo_2024.gpkg',
     name: 'geo_2024',
     size: '5.00',
     priority: true
   });
